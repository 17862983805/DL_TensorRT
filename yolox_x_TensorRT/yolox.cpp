...
const char* bindingName[10] = {"input",\
                      ...
                      "1580","1581","1582"};
std::string input_blob_name = "input";
std::vector<std::string> cls_output_blob_name = {"1542", "1561", "1580"};
std::vector<std::string> reg_output_blob_name = {"1543", "1562", "1581"};
std::vector<std::string> obj_output_blob_name = {"1544", "1563", "1582"};
